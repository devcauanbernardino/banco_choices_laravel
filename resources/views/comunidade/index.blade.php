...
.cm-avatar { width: 46px; height: 46px; border-radius: 50%; background: linear-gradient(135deg,#8b1fb8,#6a0392); color: #fff; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 1rem; }

.cm-post__head { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-bottom: 12px; }
.cm-post__author { display: flex; align-items: center; gap: 12px; }
.cm-post__name { font-weight: 700; color: var(--app-text); font-size: .95rem; margin: 0; }
.cm-post__time { color: var(--app-muted); font-size: .76rem; margin: 0; }
.cm-post__content { color: var(--app-text); font-size: .95rem; line-height: 1.6; white-space: pre-line; margin-bottom: 14px; }

.cm-post__actions { display: flex; border-top: 1px solid rgba(120,120,140,.12); margin-top: 6px; }
...
.cm-action-btn .material-symbols-outlined { font-size: 1.2rem; }
...
.cm-comment__avatar { width: 30px; height: 30px; font-size: .76rem; }
