...
@push('styles')
    ...
    <style>
        ...
        /* Nav normal (sticky, ocupa seu próprio espaço no fluxo, encostada
           nas bordas) com efeito de vidro — sem pílula flutuante, sem
           position:fixed. O blur vai num ::before próprio (não direto no
           .lp-topbar__inner) porque backdrop-filter num ancestral cria um
           novo "containing block" pra descendentes position:fixed (regra da
           spec), o que quebrava o cálculo de posição do Popper do dropdown
           de idioma (strategy:"fixed"). */
        ...
        .lp-body--dark-hero .lp-topbar::before {
            content: '';
            position: absolute;
            inset: 0;
            z-index: -1;
        ...
        .lp-body--dark-hero .lp-topbar.is-scrolled::before {
